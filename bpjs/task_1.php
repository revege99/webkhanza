            ...
            <div class="row" id="table-container" >
                <table id="registrasi" width="800" height="100%" >
                    <form method="post" action="?page=kirimTask" style="margin:0;">
                        <button type="submit" class="btn-kirim" style="margin-bottom:10px;">Kirim Semua</button>
                            <table border="1" cellspacing="0" cellpadding="4">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                            ...
                                            // Hidden input hanya untuk baris valid
                                            echo "<input type='hidden' name='data[$no][kodebooking]' value='{$row['kodebooking']}'>";
                                            for ($i = 3; $i <= 7; $i++) {
                                                echo "<input type='hidden' name='data[$no][task][$i]' value='{$row['task' . $i]}'>";
                                            }
                                    ?>
                                        <tr>
