...
<table cellspacing="0" cellpadding="3">
    ...
    <tr>
        <td colspan="12" style="text-align: left; border-bottom: 1px solid black;">
            Keluhan pasien saat datang ke FKTP: ' . htmlspecialchars($data_pasien['keluhan'] ?? '') . '
        </td>
    </tr>
    <tr>
    <td colspan="6" style="font-weight:bold; text-align:left;">PEMERIKSAAN FISIK</td>
    <td colspan="6" style="font-weight:bold; text-align:left;">Pemeriksaan Generalis Tubuh:</td>
  </tr>
  <tr>

        <td colspan="1" style="border-bottom: 1px solid black;font-size:9px; width:11%">
        <b>Tanda Vital:</b><br><br>
            Kesadaran<br>
            Sistole<br>
            Resp. Rate<br>
            Tinggi Badan<br>
        ...
        <td colspan="1" style="border-bottom: 1px solid black;font-size:9px; width:3% ">
            <span></span><br><br>
            :<br>
            :<br>
            :<br>
        ...
        <td colspan="1" style="border-bottom: 1px solid black;font-size:9px; width:16%">
               <span></span><br><br>
            ' . htmlspecialchars($data_pasien['kesadaran'] ?? '') . ' <br>
            ' . htmlspecialchars($data_pasien['sistole'] ?? '') . '<br>
            ' . htmlspecialchars($data_pasien['respRate'] ?? '') . ' <br>
            ' . htmlspecialchars($data_pasien['tinggibadan'] ?? '') . '<br>
            ' . htmlspecialchars($data_pasien['lingkarperut'] ?? '') . '
        </td>
        ...
        <td colspan="1" style="border-bottom: 1px solid black;  font-size:9px; width:5%">
               <span></span><br><br>
            ' . htmlspecialchars($data_pasien['suhu_tubuh'] ?? '') . ' <br>
            ' . htmlspecialchars($data_pasien['diastole'] ?? '') . '<br>
            ' . htmlspecialchars($data_pasien['heartRate'] ?? '') . ' <br>
            ' . htmlspecialchars($data_pasien['beratBadan'] ?? '') . '
            ' . htmlspecialchars(hitungIMT($data_pasien['beratBadan'] ?? 0, $data_pasien['tinggibadan'] ?? 0)) . '
    ...
    <td colspan="3" valign="top" style="vertical-align:top;font-size:9px;border-bottom: 1px solid black;">
      <b>Mata:</b><br> -<br>
      <b>Hidung:</b><br> -<br>
      <b>Telinga:</b><br> -<br>
      <b>Orofaring:</b><br> -<br>
    ...
    <td colspan="3" valign="top" style="vertical-align:top;font-size:9px;border-bottom: 1px solid black;">
      ...
      <b>Jantung:</b><br> -<br>
      <b>Abdomen:</b><br> -<br>
      <b>Ekstremitas atas:</b><br> -<br>
      <b>Ekstremitas bawah:</b><br> -<br>
      
    </td>
  </tr>
  <tr>
    <td colspan="12" style="font-weight:bold; text-align:left;">PEMERIKSAAN PENUNJANG</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="12" style="font-weight:bold; border-bottom: 1px solid black; text-align:left;">Riwayat Alergi : ' . htmlspecialchars($data_pasien['alergi'] ?? '') . ' </td>
  </tr>
  <tr>
    <td colspan="6" style="text-align:left;border-bottom: 1px solid black;">
        <b>Diagnosa Primer</b> :<br>  ' . htmlspecialchars($data_pasien['nmDiag1'] ?? '') . ' <br>
        <b>Diagnosa Sekunder</b> : <br>' . htmlspecialchars($data_pasien['nmDiag2'] ?? '') . ' <br>
        <b>Tindakan (Procedure)</b> : <br>' . htmlspecialchars($data_pasien['nmDiag2'] ?? '') . ' <br>
     </td>
    <td colspan="6" style=" text-align:left;border-bottom: 1px solid black;">
        <b>Terapi</b> :<br> 
        <b>Medicamentosa:</b> <br>' . htmlspecialchars($data_pasien['terapi'] ?? '') . '<br>
        
        <b>Non Medicamentosa;</b> <br>
        <b>Edukasi;</b> <br>' . htmlspecialchars($data_pasien['instruksi'] ?? '') . '<br>
        <b>BMHP;</b> <br>' . htmlspecialchars($data_pasien['bmhp'] ?? '') . '
     </td>
  </tr>
   <tr>
    <td colspan="12" style="font-weight:bold; border-bottom: 1px solid black; text-align:left;">Prognosa : ' . htmlspecialchars($data_pasien['NmPrognosa'] ?? '') . ' </td>
  </tr>
  <tr>
    <td colspan="12" style="font-weight:bold; border-bottom: 1px solid black; text-align:left;">Jenis Tagihan Non Kapitasi </td>
  </tr>
   <tr>
    <td colspan="3" style="font-weight:bold; border-bottom: 1px solid black; text-align:left;">Tenaga Kesehatan</td>
    <td colspan="1" style=" border-bottom: 1px solid black; text-align:left;">:</td>
    <td colspan="8" style=" border-bottom: 1px solid black; text-align:left;">' . htmlspecialchars($data_pasien['nm_dokter'] ?? '') . '</td>
  </tr>
   <tr>
    <td colspan="3" style="font-weight:bold; border-bottom: 1px solid black; text-align:left;">Biaya yang diajukan</td>
    <td colspan="1" style=" border-bottom: 1px solid black; text-align:left;">:</td>
    <td colspan="8" style=" border-bottom: 1px solid black; text-align:left;"></td>
  </tr>
   <tr>
    <td colspan="12" style="text-align:left;">Keterangan ini saya buat sesuai dengan data yang diberikan dan dapat dipertanggungjawabkan</td>
  </tr>
 <tr>
    <td colspan="6" style="font-weight:bold;text-align:left;"></td>
    <td colspan="6" style=" text-align:center;">Penanggung Jawab Klaim</td>
  </tr>
<br>
  <tr>
    <td colspan="6" style="text-align:left;">Nama Petugas Entri</td>
    <td colspan="6" style="text-align:left;"></td>
  </tr>
  <br><br>
   <tr>
    <td colspan="6" style="text-align:left;"></td>
    <td colspan="6" style="font-weight:bold;text-align:center;">' . htmlspecialchars($data_pasien['nm_dokter'] ?? '') . ' <br></td>
  </tr>
...
// Output PDF
$pdf->Output('fkpp' . preg_replace('/[^A-Za-z0-9_\-]/', '_', $data_pasien['nm_pasien'] ?? '') . '.pdf', 'I');
