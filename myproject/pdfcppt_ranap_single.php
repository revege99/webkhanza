...
$query = $koneksi->prepare("
    ...
    AND pemeriksaan_ranap.jam_rawat = ?
    AND pemeriksaan_ranap.tgl_perawatan BETWEEN ? AND ?
");

$query->bind_param("ssss", $no_rawat, $jam_rawat, $tgl_perawatan1, $tgl_perawatan2);
$query->execute();
...
do {
    $html .= '<tr>
        ...
        <td style="border: 1px solid black;">
            ...
            <b>P:</b> ' . htmlspecialchars($data_pasien['rtl']) . '<br><br>
        ...
        <td style="border: 1px solid black;">
            <b>Intruksi:</b> ' . htmlspecialchars($data_pasien['instruksi']) . '<br><br>
